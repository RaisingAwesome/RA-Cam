...
<html>
<body>
<img src="/stream.mjpg" width="1920" height="1442" />
</body>
</html>
"""
...
with picamera.PiCamera(resolution='1920x1442', framerate=20) as camera:
    output = StreamingOutput()
    #Uncomment the next line to change your Pi's Camera rotation (in degrees)
    camera.rotation = 180
    camera.start_recording(output, format='mjpeg', quality=1)
    try:
        address = ('', 8555)
